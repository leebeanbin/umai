...
RATE_AUTH_UPDATE_ME    = "20/minute"   # PATCH /auth/me
RATE_CHAT_CREATE       = "60/minute"
RATE_CHAT_MESSAGE      = "120/minute"
RATE_CHAT_UPDATE       = "60/minute"   # PATCH /chats/{id}
RATE_CHAT_DELETE       = "30/minute"   # DELETE /chats/{id}
RATE_CHAT_TITLE        = "30/minute"   # POST /chats/{id}/title (Ollama call)
RATE_CHAT_MEMBER       = "30/minute"   # POST/PATCH/DELETE /chats/{id}/members
RATE_CHAT_MSG_BATCH    = "60/minute"   # POST /chats/{id}/messages/batch
RATE_CHAT_MSG_RATING   = "60/minute"   # PATCH /chats/{id}/messages/{id}/rating
RATE_RAG_SEARCH        = "30/minute"
RATE_TASK_KNOWLEDGE        = "10/hour"
RATE_TASK_EXTRACT          = "20/minute"
RATE_WORKFLOW_CREATE   = "30/minute"   # POST /workflow/
RATE_WORKFLOW_UPDATE   = "60/minute"   # PATCH /workflow/{id}
RATE_WORKFLOW_DELETE   = "30/minute"   # DELETE /workflow/{id}
RATE_WORKFLOW_RUN      = "10/minute"   # POST /workflow/{id}/run (AI task trigger)
RATE_WORKFLOW_RESUME       = "30/minute"
RATE_WORKFLOW_CANCEL   = "30/minute"   # POST/DELETE /workflow/runs/{id}/cancel
RATE_FOLDER_WRITE      = "30/minute"   # POST/PATCH/DELETE /folders
RATE_WORKSPACE_ITEM_WRITE          = "30/minute"   # POST/PATCH/DELETE /workspace/items
RATE_WORKSPACE_KNOWLEDGE_UPLOAD    = "20/minute"   # POST /workspace/knowledge
RATE_WORKSPACE_KNOWLEDGE_DELETE    = "20/minute"   # DELETE /workspace/knowledge/{id}
RATE_ADMIN_USER_WRITE  = "30/minute"   # PATCH/DELETE /admin/users/{id}
RATE_ADMIN_SETTINGS_WRITE = "10/minute"  # PATCH /admin/settings
RATE_ADMIN_OLLAMA_WRITE   = "5/minute"   # POST /admin/ollama/pull, DELETE /admin/ollama/models/{name}
RATE_FINE_TUNE_DATASET     = "20/minute"
RATE_FINE_TUNE_JOB         = "10/minute"
RATE_TASK_IMAGE        = "20/minute"   # POST /tasks/image/* (리사이즈·OCR·분석 등)
RATE_TASK_IMAGE_GEN    = "5/minute"    # POST /tasks/image/generate (DALL-E, 비용 높음)
RATE_TASK_IMAGE_EDIT   = "5/minute"    # POST /tasks/image/edit / remove-bg / compose
RATE_TASK_AI_AGENT     = "10/minute"   # POST /tasks/ai/agent (multi-step LLM 루프)
RATE_TASK_AI_SEARCH    = "30/minute"   # POST /tasks/ai/search (웹 검색)
